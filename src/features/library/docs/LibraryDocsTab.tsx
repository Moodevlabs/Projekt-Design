...
/**
 * Sekcja biblioteki dla jednego rodzaju dokumentu (T-102): Termin · Etapy
 * współpracy · Cennik dodatkowy.
 *
 * Jeden komponent, trzy zakładki — wiersze różnią się tylko polami formularza
 * (`DocEntryForm`), a lista, dodawanie, kolejność i usuwanie są te same.
