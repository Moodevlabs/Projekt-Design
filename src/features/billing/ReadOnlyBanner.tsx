...
export function ReadOnlyBanner() {
  ...
  return (
    <div className="flex flex-wrap items-center gap-3 border-b border-[var(--doc-hair-strong)] bg-[var(--doc-danger-wash)] px-7 py-2.5">
      <Lock className="size-4 shrink-0 text-[var(--doc-terracotta)]" aria-hidden />
